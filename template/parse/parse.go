...
// file:
//	{{file pipeline}} itemList {{end}}
//	{{file pipeline}} itemList {{else}} itemList {{end}}
// If keyword is past.
func (t *Tree) fileControl() Node {
	return newFile(t.parseControl(false, "file"))
}
