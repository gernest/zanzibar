...
func newFile(pos Pos, line int, pipe *PipeNode, list, elseList *ListNode) *FileNode {
	return &FileNode{BranchNode{NodeType: NodeFile, Pos: pos, Line: line, Pipe: pipe, List: list, ElseList: elseList}}
}

func (r *FileNode) Copy() Node {
	return newFile(r.Pos, r.Line, r.Pipe.CopyPipe(), r.List.CopyList(), r.ElseList.CopyList())
}
